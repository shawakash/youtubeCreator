...
/* harmony import */ var private_next_pages_api_video_addUploadVideo_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8147);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_video_addUploadVideo_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_video_addUploadVideo_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_video_addUploadVideo_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_video_addUploadVideo_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/video/addUploadVideo",
        pathname: "/api/video/addUploadVideo",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_video_addUploadVideo_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function handler(req, res) {
    ...
    try {
        ...
        (0,_auth_middle__WEBPACK_IMPORTED_MODULE_1__["default"])(req, res, async ()=>{
            ...
            const parsedInput = zodTypes__WEBPACK_IMPORTED_MODULE_2__/* .uploadVideoType */ .Jp.safeParse(req.body);
            ...
            const editVideo = await db__WEBPACK_IMPORTED_MODULE_0__/* .EditedVideo */ .gw.findOne({
                videoKey
            });
            ...
            const newUploadVideo = new db__WEBPACK_IMPORTED_MODULE_0__/* .UploadVideo */ .CP({
                ...parsedInput.data,
                uploadId: uploadid
            });
...
var __webpack_exports__ = __webpack_require__.X(0, [193,809,898,221], () => (__webpack_exec__(694)));

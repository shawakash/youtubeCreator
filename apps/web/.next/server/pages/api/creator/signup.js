...
/* harmony import */ var private_next_pages_api_creator_signup_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8737);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_api_creator_signup_ts__WEBPACK_IMPORTED_MODULE_3__]);
private_next_pages_api_creator_signup_ts__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_creator_signup_ts__WEBPACK_IMPORTED_MODULE_3__, "default"));
// Re-export config.
const config = (0,next_dist_build_webpack_loaders_next_route_loader_helpers__WEBPACK_IMPORTED_MODULE_2__/* .hoist */ .l)(private_next_pages_api_creator_signup_ts__WEBPACK_IMPORTED_MODULE_3__, "config");
// Create and export the route module that will be consumed.
const routeModule = new PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_future_route_kind__WEBPACK_IMPORTED_MODULE_1__/* .RouteKind */ .x.PAGES_API,
        page: "/api/creator/signup",
        pathname: "/api/creator/signup",
        // The following aren't used in production.
        bundlePath: "",
        filename: ""
    },
    userland: private_next_pages_api_creator_signup_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function handler(req, res) {
    ...
    try {
        ...
        const parsedInput = zodTypes__WEBPACK_IMPORTED_MODULE_1__/* .creatorInputValid */ .HT.safeParse(req.body);
        ...
        const isCreator1 = await db__WEBPACK_IMPORTED_MODULE_0__/* .Creator */ .g6.findOne({
            username
        });
        if (isCreator1) {
            return res.status(400).json({
        ...
        const isCreator2 = await db__WEBPACK_IMPORTED_MODULE_0__/* .Creator */ .g6.findOne({
            email
        });
        if (isCreator2) {
            return res.status(400).json({
        ...
        const creator = new db__WEBPACK_IMPORTED_MODULE_0__/* .Creator */ .g6(parsedInput.data);
        await creator.save();
        ...
        const cookieSerialized = (0,cookie__WEBPACK_IMPORTED_MODULE_3__.serialize)("creatorToken", token, {
            httpOnly: true,
...
var __webpack_exports__ = __webpack_require__.X(0, [193,809,221], () => (__webpack_exec__(3302)));

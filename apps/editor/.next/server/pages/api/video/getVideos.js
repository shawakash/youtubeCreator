...
async function handler(req, res) {
    ...
    try {
        ...
        (0,_middle__WEBPACK_IMPORTED_MODULE_2__["default"])(req, res, async ()=>{
            ...
            if (type === "raw") {
                const videos1 = await db__WEBPACK_IMPORTED_MODULE_0__/* .RawVideo */ .r2.find({
                    editor: null
                }).populate([
                    {
                        path: "creator",
            ...
            if (type === "edit") {
                const editedVideos = await db__WEBPACK_IMPORTED_MODULE_0__/* .EditedVideo */ .gw.find({
                    editor: _id
                }).populate([
                    {
                        path: "creator",
                ...
                if (editedVideos.length == 0) {
                    return res.status(200).json({
                        message: "Start by taking raw videos",
                        edit: []
                    });
                }
                try {
...
var __webpack_exports__ = __webpack_require__.X(0, [193,809,960], () => (__webpack_exec__(2292)));
